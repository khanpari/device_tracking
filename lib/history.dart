...
class _HistoryState extends State<History>
{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(top:30,bottom: 100,left: 20,right: 20),
        child: Container(
    ...
    itemBuilder: (context, index) {
          ...
          return Stack(children: [
              ...
              Positioned(top: 15.0, left: 5.0, child: ConstrainedBox(
                  ...
                  child: new DecoratedBox(
                    decoration: new BoxDecoration(color: Color(0xff359DED),
